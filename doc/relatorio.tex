...
\section{Estatísticas acerca das estruturas de dados}
Usando o ficheiro \verb|wordlist-big-latest.txt| como argumento, foram obtidas as seguintes estatísticas acerca da \textit{hash table}, bem como dos grafos:
\begin{itemize}
	\item Número de entradas: 999282
	\item Número de colisões: 209894
	\item Tamanho da \textit{hash table}: 2048000
	\item Número de nós: 999282
	\item Número de vértices: 1060534
	\item Número de nós de vértices: 2121068
	\item Número de componentes conectados: 377234
	\item Tamanho do maior componente conectado: 16698
\end{itemize}
