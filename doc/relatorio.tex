...
\noindent Outras \textit{word ladders} interessantes com 4 letras são:
\begin{itemize}
...
\subsection{Palavras com 5 letras}
A maior \textit{word ladder} encontrada ocorre entre as palavras ``fo-la'' e ``expõe'':
\begin{multicols}{4}
	\begin{enumerate}
		\itemsep 0em
		\item fo-la
...
\subsection{Palavras com 6 letras}
A maior \textit{word ladder} encontrada ocorre entre as palavras ``enrugo'' e ``zelote'':
\begin{multicols}{4}
	\begin{enumerate}
		\itemsep 0em
		\item enrugo
